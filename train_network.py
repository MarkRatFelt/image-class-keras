...
EPOCHS = 25  # epochs are "steps" for training
INIT_LR = 1e-3  # learning rate
BATCH_SIZE = 32  # Batch size (if you don't know what this is, look for it on Internet)
...
# construct the image generator for data augmentation, for a better dataset
...
plt.title("Training Loss and Accuracy on Weed/Not Weed")
plt.xlabel("Epoch #")
